    ...
    <a-config-provider :locale="locale">
        <div class="form-designer-container-9136076486841527">
          ...
          'show-head-and-toolbars-top': toolbarsTop && showHead
                ...
                <!-- 左侧控件区域 start -->
                <aside class="left">
                    <a-collapse :defaultActiveKey="collapseDefaultActiveKey" @change="collapseChange">
                        <!-- 基础控件 start -->
                        <!-- <a-collapse-panel header="基础控件" key="1" v-if="basicsArray.length > 0"> -->
                        <h2 style="text-align:center">组件库</h2>
            ...
            >
              ...
              />
                        ...
                        <!-- 其他控件 start -->
                        <!-- <a-collapse-panel header="其他控件" key="4" v-if="layoutArray.length > 0">
                            <collapseItem :list="layoutArray" @generateKey="generateKey" @handleListPush="handleListPush" @start="handleStart" />
                        </a-collapse-panel>-->
                        <!-- 其他控件 end -->
                    </a-collapse>
                ...
                <aside class="right">
                    ...
                    <!-- <a-tabs :activeKey="activeKey" :tabBarStyle="{ margin: 0 }" @change="changeTab"> -->
                    <!-- <a-tab-pane :key="1" tab="表单属性设置">
                            <formProperties :config="data.config" :previewOptions="previewOptions" />
                    </a-tab-pane>-->
                    <!-- <a-tab-pane :key="1" tab="控件属性设置"> -->
                    <h3>数据配置</h3>
                    <formItemProperties :selectItem="selectItem" class="form-item-properties" />
                    <!-- </a-tab-pane> -->
                    <!-- </a-tabs> -->
                    <!-- <formItemProperties  :selectItem="selectItem" class="form-item-properties" /> -->
                </aside>
...
import previewModal from "../MorFormPreview/index.vue";
        ...
        list: [
          {
            ...
            model: "textarea_1645150707889",
            key: "textarea_1645150707889",
            help: "",
            rules: [
              {
                required: false,
          ...
          },
          {
            ...
            model: "radio_1645150708928",
            key: "radio_1645150708928",
            help: "",
            rules: [
              {
                required: false,
